...
public class RestaurantOrderDAO {
    ...
    private Map<String, OrderResponseDTO> generateRandomOrders() {
        ...
        orderMap.put("9u71245h", new OrderResponseDTO("9u71245h", "Hamburger", 2, 641, new Date(), "PREPARING", 59));
        orderMap.put("37jbd832", new OrderResponseDTO("37jbd832", "Mloukhia", 1, 325, new Date(), "DELIVERED", 0));
        return orderMap;
    }
